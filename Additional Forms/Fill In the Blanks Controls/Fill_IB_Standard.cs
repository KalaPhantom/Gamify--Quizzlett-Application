...
{
    public partial class Fill_IB_Standard : UserControl
    {
        ...
        public Fill_IB_Standard(FlowLayoutPanel card_container, Quiz_Data_Model quiz, QuestionModel_FillBlanks model)
        {
            InitializeComponent();
        ...
        #region Fill in the blanks algorithm
        public void parser()
        {
        ...
        private void answer_txbx_KeyDown_1(object sender, KeyEventArgs e)
        {
